...
<form action="<?=$_SERVER["PHP_SELF"]?>">
    ...
    <div>
        <label for="size">Taille :</label><input type="number" id="size" name="size" value="<?=$size?>">
    </div>
    <div>
        <input type="checkbox" id="ckBold" name="ckBold">
        <label for="ckBold">Gras :</label>
        <input type="checkbox" id="ckItalic" name="ckItalic" value="italic">
        <label for="ckItalic">Italique :</label>
    </div>
        <label for="ckItalic">Italique :</label><input type="checkbox" id="ckItalic" name="ckItalic" <?=$italic?"checked":""?>>
